...
import 'package:cooig_firebase/home_screen.dart';
...
class Othersociety extends StatefulWidget {
  dynamic userId;
  final dynamic otheruserid;

  Othersociety({super.key, required this.userId, required this.otheruserid});

  @override
  State<Othersociety> createState() => _OthersocietyState();
}



class _OthersocietyState extends State<Othersociety>
          ...
          return SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                _buildPostStream(widget.otheruserid),
              ],
            ),
          );
        },
