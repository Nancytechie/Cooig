...
class SocietyLogin extends StatefulWidget {
  const SocietyLogin({super.key});

  @override
  State<SocietyLogin> createState() => _SocietyLoginState();
}

class _SocietyLoginState extends State<SocietyLogin> {
  ...
  Future<void> _SocietyLoginloginWithGoogle() async {
    try {
  ...
  Future<void> _SocietyLoginloginWithEmail() async {
    setState(() {
    ...
    try {
      ...
      if (user != null) {
        // If SocietyLoginlogin is successful, navigate to the home page
        ...
        Fluttertoast.showToast(
          msg: 'SocietyLogin failed. Please try again later.',
      ...
      if (e.code == 'user-not-found') {
        ...
        Fluttertoast.showToast(
          msg: 'Too many SocietyLoginlogin attempts. Please try again later.',
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM,
        );
      } else {
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      ...
                      Center(
                        child: ElevatedButton(
                          onPressed: _SocietyLoginloginWithEmail,
                          style: ButtonStyle(
              ...
              ElevatedButton(
                onPressed: _SocietyLoginloginWithGoogle,
